        ...
        protected function renderTextField($idInputName)
        {
            ...
            $cClipWidget->widget('zii.widgets.jui.CJuiAutoComplete', array(
                ...
                'options' => array(
                    ...
                    'search'   => 'js: function(event, ui) { var context = $("#'.$this->getIdForTextField().'").parent(); $(".model-select-icon", context).fadeOut(100); makeToggableSpinner(context, true); }',
                    'open'     => 'js: function(event, ui) { var context = $("#'.$this->getIdForTextField().'").parent(); $(".model-select-icon", context).fadeIn(250);  makeToggableSpinner(context, false); }',
                    'close'    => 'js: function(event, ui) { var context = $("#'.$this->getIdForTextField().'").parent(); $(".model-select-icon", context).fadeIn(250);  makeToggableSpinner(context, false); }'
                ),
                'htmlOptions' => array(
                    'disabled' => $this->getDisabledValue(),
