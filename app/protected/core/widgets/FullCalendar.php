<?php
    ...
    class FullCalendar extends ZurmoWidget
    {
        ...
        public function run()
        {
            ...
            $cs->registerCssFile($baseScriptUrl . '/fullCalendar/fullcalendar.min.js');
            $cs->registerScriptFile($baseScriptUrl . '/fullCalendar/fullcalendar.css', CClientScript::POS_END);
