<?php
    ...
    class DatabaseCompatibilityUtilTest extends BaseTest
    {
        ...
        */
        ...
        {
            $this->assertTrue(DatabaseCompatibilityUtil::checkDatabaseConnection('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort));

            $compareData = array(1045, "Access denied for user");
            $result = DatabaseCompatibilityUtil::checkDatabaseConnection('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername,   'wrong', $this->temporaryDatabasePort);
            $result[1] = substr($result[1], 0, 22);
            $this->assertEquals($compareData, $result);
            $result = DatabaseCompatibilityUtil::checkDatabaseConnection('mysql', $this->temporaryDatabaseHostname, 'nobody', 'password', $this->temporaryDatabasePort);
            $result[1] = substr($result[1], 0, 22);
            $this->assertEquals($compareData, $result);
        }
        ...
        public function testCheckDatabaseExists()
        {
            ...
            {
                $this->assertTrue(DatabaseCompatibilityUtil::checkDatabaseExists('mysql', $this->testDatabaseHostname, $this->testDatabaseUsername, $this->testDatabasePassword, $this->testDatabasePort, $this->testDatabaseName));
                $this->assertEquals(array(1049, "Unknown database 'junk'"),
                DatabaseCompatibilityUtil::checkDatabaseExists('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort, 'junk'));
            }
        }
        ...
        public function testCheckDatabaseUserExists()
        {
            ...
            if ($this->temporaryDatabaseUsername == 'root')
            {
                $this->assertTrue (DatabaseCompatibilityUtil::checkDatabaseUserExists('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort, $this->temporaryDatabaseUsername));
                $this->assertFalse(DatabaseCompatibilityUtil::checkDatabaseUserExists('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort, 'dude'));
            }
        }
        ...
        public function testCreateDatabaseUser()
        {
            ...
            if ($this->temporaryDatabaseUsername == 'root')
            {
                ...
                $this->assertTrue(DatabaseCompatibilityUtil::createDatabaseUser('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort, $this->temporaryDatabaseName, 'wacko', ''));
            }
        }
        ...
        */
        ...
        public function testDatabaseBackupAndRestore()
        {
            ...
            if (RedBeanDatabase::getDatabaseType() == 'mysql')
            {
                ...
                $this->assertTrue(DatabaseCompatibilityUtil::backupDatabase('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort, $this->temporaryDatabaseName, $this->databaseBackupTestFile));

                //Drop database, and restore it from backup.
                $this->assertTrue(DatabaseCompatibilityUtil::createDatabase('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort, $this->temporaryDatabaseName));
                $this->assertTrue(DatabaseCompatibilityUtil::restoreDatabase('mysql', $this->temporaryDatabaseHostname, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword, $this->temporaryDatabasePort, $this->temporaryDatabaseName, $this->databaseBackupTestFile));
                $connection = @mysql_connect($this->temporaryDatabaseHostname . ':' . $this->temporaryDatabasePort, $this->temporaryDatabaseUsername, $this->temporaryDatabasePassword);
