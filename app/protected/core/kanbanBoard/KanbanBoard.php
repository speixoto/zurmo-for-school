    ...
    class KanbanBoard
    {
        ...
        public function getThemeNamesAndLabels()
        {
            return array(''                    => Zurmo::t('Core', 'White'),
                ...
                'kanban-background-abstract-2' => Zurmo::t('Core', 'Lights'),
                'kanban-background-abstract-3' => Zurmo::t('Core', 'Fun at Night'),
                'kanban-background-abstract-4' => Zurmo::t('Core', 'Abstraction'),
                'kanban-background-beach-1'    => Zurmo::t('Core', 'Beach'),
                'kanban-background-beach-2'    => Zurmo::t('Core', 'Ocean'),
                'kanban-background-beach-3'    => Zurmo::t('Core', 'Sand and Water'),
                'kanban-background-beach-4'    => Zurmo::t('Core', 'Sandals'),
                'kanban-background-vintage-1'  => Zurmo::t('Core', 'Vintage Bridge'),
                'kanban-background-vintage-2'  => Zurmo::t('Core', 'Vintage Building'),
                'kanban-background-vintage-3'  => Zurmo::t('Core', 'Vintage City'),
        ...
        public function getThemeColorNamesAndUnlockedAtLevel()
        {
            return array(''                    => 1,
                ...
                'kanban-background-abstract-1' => 3,
                'kanban-background-abstract-2' => 3,
                'kanban-background-abstract-3' => 4,
                'kanban-background-abstract-4' => 4,
                'kanban-background-beach-1'    => 5,
                'kanban-background-beach-2'    => 6,
                'kanban-background-beach-3'    => 7,
                'kanban-background-beach-4'    => 8,
                'kanban-background-vintage-1'  => 9,
                'kanban-background-vintage-2'  => 10,
                'kanban-background-vintage-3'  => 11,
                'kanban-background-van-gogh'   => 12,
                'kanban-background-miro'       => 13,
                'kanban-background-wave'       => 14);
            return $data;
        }
