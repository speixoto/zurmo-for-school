            ...
            $metadata[__CLASS__] = array(
                ...
                'relations' => array(
                    ...
                    'hasOne'    => array(RedBeanModel::HAS_ONE,             'WorkflowModelTestItem',
                                            RedBeanModel::NOT_OWNED, RedBeanModel::LINK_TYPE_SPECIFIC, 'hasOne'),
                    'hasOne2'   => array(RedBeanModel::HAS_ONE,             'WorkflowModelTestItem5',
                                            RedBeanModel::NOT_OWNED, RedBeanModel::LINK_TYPE_SPECIFIC, 'hasOne2'),
                    'hasOne3'   => array(RedBeanModel::HAS_ONE,   'WorkflowModelTestItem', RedBeanModel::NOT_OWNED,
                                            RedBeanModel::LINK_TYPE_SPECIFIC, 'hasOne3'),
                    'hasOne4'   => array(RedBeanModel::HAS_ONE,   'WorkflowModelTestItem8', RedBeanModel::NOT_OWNED,
                                            RedBeanModel::LINK_TYPE_SPECIFIC, 'hasOne4'),
                ),
                'rules' => array(
