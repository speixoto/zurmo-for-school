<?php
     ...
     */
    class MeetingsExistPerUserAndDayCheckControllerFilter extends CFilter
    {
        public $controller;
        ...
        protected function preFilter($filterChain)
        {
            try
            {
                if (isset($_GET['stringTime']))
                {
                    $stringTime = $_GET['stringTime'];
                    ...
                    $searchAttributeData['clauses'] = array(
                        1 => array(
                            ...
                            'value'                => DateTimeUtil::
                                                        convertDateIntoTimeZoneAdjustedDateTimeBeginningOfDay($stringTime),
                        ),
                        2 => array(
                            'attributeName'        => 'startDateTime',
                            'operatorType'         => 'lessThanOrEqualTo',
                            'value'                => DateTimeUtil::
                                                        convertDateIntoTimeZoneAdjustedDateTimeEndOfDay($stringTime),
                        ),
                        3 => array(
                            'attributeName'        => 'owner',
                            'operatorType'         => 'equals',
                    ...
                    $models = Meeting::getSubset($joinTablesAdapter, null, null, $where, null);
            ...
            catch (NotFoundException $e)
            {
                ...
                $messageView = new NoMeetingsYetView($redirectUrl);
