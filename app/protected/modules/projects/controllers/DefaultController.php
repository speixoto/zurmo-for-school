<?php
    ...
    class ProjectsDefaultController extends ZurmoModuleController
    {
        ...
        public function actionDetails($id)
        {
            ...
            AuditEvent::logAuditEvent('ZurmoModule', ZurmoModule::AUDIT_EVENT_ITEM_VIEWED, array(strval($product), 'ProjectsModule'), $product);
        ...
        {
            $params          = LabelUtil::getTranslationParamsForAllModules();
            $title           = Zurmo::t('ProductTemplatesModule', 'Mass Delete ProjectsModulePluralLabel', $params);
