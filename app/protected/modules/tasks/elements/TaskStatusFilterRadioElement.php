<?php
    ...
    /**
     * Element for displaying a status filter for tasks list view.  You can either
     * view tasks in different status.
     */
    class TaskStatusFilterRadioElement extends Element
    {
        /**
        ...
        {
            assert('$this->model instanceof TasksConfigurationForm');
            $content = $this->form->radioButtonList(
                $this->model,
                $this->attribute,
                $this->getStatusDropDownArray(),
         ...
         * @return array
         */
        protected function getStatusDropDownArray()
        {
            $data                       = CMap::mergeArray(array(TasksConfigurationForm::FILTERED_BY_ALL_STATUS
                                                                            => Zurmo::t('Core', 'All')), Task::getStatusDropDownArray());
            return $data;
        }
    }
?>