<?php
    ...
    {
        /**
         * Called from outside to render status value as label. @see TasktStatusDropDownListViewColumnAdapter
         * Called from outside to render status value as label. @see TasktStatusDropDownStatusListViewColumnAdapter
         * @param int $status
        ...
        public static function renderDisplayAttributeForReport($model, $attribute)
        {
            ...
            {
                $dataArray = Task::getStatusDropDownArray();
            }
            else
            {
