<?php
    ...
    class TasksUtil
    {
        ...
        {
            $peopleToSendNotification = static::resolvePeopleToSendNotificationToOnNewTask($task);
            foreach ($peopleToSendNotification as $person)
            {
                ...
                {
                    EmailNotificationUtil::resolveAndSendEmail($task->owner,
                                                               array($person),
                                                               static::getEmailSubject($task),
                                                               static::getEmailContent($task, $person));
                }
            }
        }
         ...
         */
        public static function resolvePeopleToSendNotificationToOnNewTask(Task $task)
        {
