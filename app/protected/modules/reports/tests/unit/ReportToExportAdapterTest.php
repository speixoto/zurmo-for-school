    ...
    class ReportToExportAdapterTest extends ZurmoBaseTest
    {
        ...
        public function testExportRelationAttributes()
        {
            ...
            $compareHeaderData  = array('Name',
                                        'Reports Tests Module >> Boolean',
                                        'Reports Tests Module >> Date',
                                        'Reports Tests Module >> Date Time',
                                        'Reports Tests Module >> Float',
                                        'Reports Tests Module >> Integer',
                                        'Reports Tests Module >> Phone',
                                        'Reports Tests Module >> String',
                                        'Reports Tests Module >> Text Area',
                                        'Reports Tests Module >> Url',
                                        'Reports Tests Module >> Drop Down',
                                        'Reports Tests Module >> Currency Value',
                                        'Reports Tests Module >> Currency Value Currency',
                                        'Reports Tests Module >> Primary Address >> Street 1',
                                        'Reports Tests Module >> Primary Email >> Email Address',
                                        'Reports Tests Module >> Multi Drop Down',
                                        'Reports Tests Module >> Tag Cloud',
                                        'Reports Tests Module >> Radio Drop Down',
                                        'Reports Tests Module >> A name for a state',
                                        'Reports Tests Module >> Owner');
            $compareRowData     = array('xFirst xLast', 1, '2013-02-12', '2013-02-12 10:15:00',
                                        10.5, 10, '7842151012', 'xString', 'xtextAreatest',
                                        'http://www.test.com', 'Test2', '$100.00', 'USD', 'someString', 'test@someString.com',
                                        'Multi 1,Multi 2', 'Cloud 2,Cloud 3', 'Test2', 'someName', 'super');
