<?php
    ...
    class MapsRegularUserWalkthroughTest extends ZurmoRegularUserWalkthroughBaseTest
    {
        ...
        public function testRegularUserAllControllerActionsNoElevation()
        {
            ...
            //echo $accounts[0]->billingAddress->latitude;
            //echo '<==>'.$accounts[0]->billingAddress->longitude;die;
            $this->assertEquals(round('42.3854311', 4),  round($accounts[0]->billingAddress->latitude, 4));
            $this->assertEquals(round('-88.209049', 4), round($accounts[0]->billingAddress->longitude, 4));
