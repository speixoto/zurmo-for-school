<?php
    ...
    class CurrencyValueRedBeanModelAttributeValueToExportValueAdapterTest extends ZurmoBaseTest
    {
        ...
        public function testGetExportValue()
        {
            ...
            $compareData = array($model->getAttributeLabel('currencyValue') => $currencyValue->value, $model->getAttributeLabel('currencyValue') . " " . Yii::t('Default', 'Currency') => $currencyValue->currency->code);
