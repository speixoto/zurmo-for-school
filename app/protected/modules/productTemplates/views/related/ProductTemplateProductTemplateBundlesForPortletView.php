<?php
    ...
    /**
     * Wrapper view for displaying an product template's product template bundles feed.
     */
    class ProductTemplateProductTemplateBundlesForPortletView extends ProductTemplateBundlesForPortletView
    {
       /**
