<?php
    ...
    /**
     * Product template bundles list view.
     */
    class ProductTemplateBundlesListView extends ListView
    {
        ...
        /**
         * If a product template bundle is posted to another user, should that show like 'Jim Smith to Mary Smith' or should it
        ...
        /**
         * Do not show any empty text since it would look strange in the product template bundle feed.
         * @var string
         */
        protected $emptyText = '';
                            ...
                            'rows' => array(
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'null', 'type' => 'ProductTemplateBundleAndComments'),
                                            ),
                                        ),
                                    )
                                ),
