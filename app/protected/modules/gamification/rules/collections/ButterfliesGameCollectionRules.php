 ...
 ********************************************************************************/
     ...
     */
    class ButterfliesGameCollectionRules extends GameCollectionRules
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('GamificationModule', 'Butterflies');
        }
        ...
        {
            return array(   'AniseSwallowtail' => Zurmo::t('GamificationModule', 'Anise Swallowtail'),
                            'Buckeye'          => Zurmo::t('GamificationModule', 'Buckeye'),
                            'Monarch'          => Zurmo::t('GamificationModule', 'Monarch'),
                            'PaintedLady'      => Zurmo::t('GamificationModule', 'Painted Lady'),
                            'Queen'            => Zurmo::t('GamificationModule', 'Queen'),
            );
        }
        ...
        {
            return Zurmo::t('GamificationModule', 'Caterpillar');
        }
    }
?>