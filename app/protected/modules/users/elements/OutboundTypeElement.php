<?php
    ...
    /**
     * Utilize this element to display a dropdown of outboundtype.
     */
    class OutboundTypeElement extends Element
    {
        /**
        ...
        {
            $title       = Yii::t('Default', 'You can use the system default outbound settings to send your emails ' .
                                             'or you customize your own settings.');
            $content     = '<span id="outbound-type-tooltip" class="tooltip"  title="' . $title . '">';
            $content    .= '?</span>';
            $qtip = new ZurmoTip(array('options' => array('position' => array('my' => 'bottom right', 'at' => 'top left'))));
            $qtip->addQTip("#outbound-type-tooltip");
            return $content;
        }
        ...
        {
            $data  = array(1 => Yii::t('Default', 'System Default'),
                           2 => Yii::t('Default', 'Custom'),
            );
            return $data;
        }
    }
