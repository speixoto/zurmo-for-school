<?php
    ...
    /**
     * Element for displaying a view filter for a product view.  You can either
     * view details, edit mode or add product.
     */
    class ProductsViewFilterRadioElement extends Element
    {
        /**
        ...
        {
            $data = array(
                        ProductsConfigurationForm::VIEW_DETAILS     => Zurmo::t('ProductsModule', 'Details'),
                        ProductsConfigurationForm::VIEW_EDIT_MODE   => Zurmo::t('ProductsModule', 'Edit Mode'),
                        ProductsConfigurationForm::VIEW_ADD_PRODUCT => Zurmo::t('ProductsModule', 'Add Product'),
                    );
